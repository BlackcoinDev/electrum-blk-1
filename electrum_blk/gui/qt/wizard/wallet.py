...
from electrum_blk.bip32 import is_bip32_derivation, BIP32Node, normalize_bip32_derivation, xpub_type
from electrum_blk.daemon import Daemon
from electrum_blk.i18n import _
from electrum_blk.keystore import bip44_derivation, bip39_to_seed, purpose48_derivation, ScriptTypeNotSupported
from electrum_blk.plugin import run_hook, HardwarePluginLibraryUnavailable
from electrum_blk.storage import StorageReadWriteError
from electrum_blk.util import WalletFileException, get_new_wallet_name, UserFacingException, InvalidPassword
from electrum_blk.util import is_subpath
from electrum_blk.wallet import wallet_types
from .wizard import QEAbstractWizard, WizardComponent
from electrum_blk.logging import get_logger, Logger
from electrum_blk import WalletStorage, mnemonic, keystore
...
class WCScriptAndDerivation(WalletWizardComponent, Logger):
    ...
    def on_ready(self):
        ...
        message2 = ' '.join([
            ...
            _('If you are using a Coinomi restore seed, use m/44\'/10\'/0\' here.'),
...
class WCImport(WalletWizardComponent):
    def __init__(self, parent, wizard):
        WalletWizardComponent.__init__(self, parent, wizard, title=_('Import Blackcoin Addresses or Private Keys'))
        message = _(
            'Enter a list of Blackcoin addresses (this will create a watching-only wallet), or a list of private keys.')
